...
export interface Variation {
  name: string;
  difficulty: number; // 1-10 scale, how difficult the variation is
}

export interface Entrance {
  name: string;
  difficulty: number; // 1-10 scale, how difficult the entrance is
}
...
export const initialTricks: Trick[] = [
  {
    ...
    "variations": [{"name": "Soul Torque", "difficulty": 3}],
  ...
  },
  {
    ...
    "difficulty": 1,
    "category": "soul_grinds",
    "variations": [{"name": "Freestyle Makio", "difficulty": 1}, {"name": "Rocket Makio", "difficulty": 4}, {"name": "Christ Makio", "difficulty": 3}],
    "possibleEntrances": [{"name": "Alleyoop", "difficulty": 3}, {"name": "Truespin", "difficulty": 4}, {"name": "Half Cab", "difficulty": 3}, {"name": "Full Cab", "difficulty": 5}, {"name": "360", "difficulty": 4}, {"name": "540", "difficulty": 6}],
    "popularity": 9
  },
  {
  ...
  },
  {
    ...
    "difficulty": 5,
    "category": "topside_grinds",
    "variations": [{"name": "Freestyle Fishbrain", "difficulty": 6}, {"name": "Rocket Fishbrain", "difficulty": 7}, {"name": "Christ Fishbrain", "difficulty": 8}],
    "possibleEntrances": [{"name": "Alleyoop", "difficulty": 3}, {"name": "Truespin", "difficulty": 4}, {"name": "Half Cab", "difficulty": 3}, {"name": "Full Cab", "difficulty": 5}, {"name": "360", "difficulty": 4}, {"name": "540", "difficulty": 6}],
    "popularity": 3
  },
  {
  ...
  },
  {
    ...
    "difficulty": 3,
    "category": "groove_grinds",
    "possibleEntrances": [{"name": "270", "difficulty": 3}, {"name": "450", "difficulty": 6}],
    "popularity": 6
  },
  {
    "id": 15,
    ...
    "difficulty": 4,
    "category": "groove_grinds",
    "variations": [{"name": "Negative Backside Royale", "difficulty": 5}],
    "possibleEntrances": [{"name": "270", "difficulty": 3}, {"name": "450", "difficulty": 5}],
    "popularity": 5
  },
  {
...
export const getRandomVariation = (
  ...
  if (difficultyPreference === 'easy') {
    // For easy, only include variations with difficulty <= 3 and <= maxDifficulty
    filteredVariations = trick.variations.filter(v => v.difficulty <= 3 && v.difficulty <= maxDifficulty);
  } else if (difficultyPreference === 'medium') {
    // For medium, only include variations with difficulty between 2 and 6 and <= maxDifficulty
    filteredVariations = trick.variations.filter(v => v.difficulty >= 2 && v.difficulty <= 6 && v.difficulty <= maxDifficulty);
  } else if (difficultyPreference === 'hard') {
    // For hard, only include variations with difficulty >= 4 and <= maxDifficulty
    filteredVariations = trick.variations.filter(v => v.difficulty >= 4 && v.difficulty <= maxDifficulty);
  } else {
...
export const getRandomEntrance = (
  ...
  if (difficultyPreference === 'easy') {
    // For easy, only include entrances with difficulty <= 3 and <= maxDifficulty
    filteredEntrances = trick.possibleEntrances.filter(e => e.difficulty <= 3 && e.difficulty <= maxDifficulty);
  } else if (difficultyPreference === 'medium') {
    // For medium, only include entrances with difficulty between 2 and 6 and <= maxDifficulty
    filteredEntrances = trick.possibleEntrances.filter(e => e.difficulty >= 2 && e.difficulty <= 6 && e.difficulty <= maxDifficulty);
  } else if (difficultyPreference === 'hard') {
    // For hard, only include entrances with difficulty >= 4 and <= maxDifficulty
    filteredEntrances = trick.possibleEntrances.filter(e => e.difficulty >= 4 && e.difficulty <= maxDifficulty);
  } else {
...
export const getCompleteRandomTrick = (
  ...
  if (includeVariation && selectedTrick.variations && selectedTrick.variations.length > 0) {
    ...
    if (possibleVariations.length > 0) {
      ...
      if (difficultyPreference === 'easy') {
        const easyVariations = possibleVariations.filter(v => v.difficulty <= 3);
        if (easyVariations.length > 0) filteredVariations = easyVariations;
      } else if (difficultyPreference === 'medium') {
        const mediumVariations = possibleVariations.filter(v => v.difficulty >= 2 && v.difficulty <= 6);
        if (mediumVariations.length > 0) filteredVariations = mediumVariations;
      } else if (difficultyPreference === 'hard') {
        const hardVariations = possibleVariations.filter(v => v.difficulty >= 4);
  ...
  if (includeEntrance && selectedTrick.possibleEntrances && selectedTrick.possibleEntrances.length > 0) {
    ...
    if (possibleEntrances.length > 0 && Math.random() > 0.3) {
      ...
      if (difficultyPreference === 'easy') {
        const easyEntrances = possibleEntrances.filter(e => e.difficulty <= 3);
        if (easyEntrances.length > 0) filteredEntrances = easyEntrances;
      } else if (difficultyPreference === 'medium') {
        const mediumEntrances = possibleEntrances.filter(e => e.difficulty >= 2 && e.difficulty <= 6);
        if (mediumEntrances.length > 0) filteredEntrances = mediumEntrances;
      } else if (difficultyPreference === 'hard') {
        const hardEntrances = possibleEntrances.filter(e => e.difficulty >= 4);
